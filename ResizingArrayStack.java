 ...
 * order.
 * <p>
 * This implementation uses a resizing array, which double the underlying array when it is full and
 * halves the underlying array when it is one-quarter full. The <em>push</em> and <em>pop</em>
